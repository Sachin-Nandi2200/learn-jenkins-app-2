pipeline {
    ...
    stages {
        ...
        stage('Deploy Prod') {
            ...
            post {
                always {
                    publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, icon: '', keepAll: false, reportDir: 'playwright-report', reportFiles: 'index.html', reportName: 'E2E Prod Report', reportTitles: '', useWrapperFileDirectly: true])
                }
            }
